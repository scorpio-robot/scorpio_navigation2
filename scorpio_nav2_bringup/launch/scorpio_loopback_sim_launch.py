...
def generate_launch_description():
    ...
    scorpio_desc_dir = get_package_share_directory("scorpio_description")
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, "params", "simulation", "nav_params.yaml"
        ),
    ...
    start_loopback_sim = Node(
        package="nav2_loopback_sim",
        executable="loopback_simulator",
        name="loopback_simulator",
        output="screen",
        parameters=[configured_params],
        remappings=remappings + [("odom", "gt/scorpio/odom"), ("scan", "ydlidar/scan")],
    )

    start_robot_state_publisher_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(scorpio_desc_dir, "launch", "robot_description_launch.py")
        ),
        launch_arguments={
            "use_sim_time": "True",
            "namespace": namespace,
    ...
    ld.add_action(start_loopback_sim)
