...
def generate_launch_description():
    ...
    start_plain_slam_ros2 = GroupAction(
        condition=IfCondition(NotSubstitution(simulation)),
        actions=[
            Node(
                ...
                respawn=use_respawn,
                respawn_delay=2.0,
                parameters=[configured_params, {"use_as_localizer": False}],
                arguments=["--ros-args", "--log-level", log_level],
            ),
            Node(
                package="plain_slam_ros2",
    ...
    # Running Plain SLAM ROS2
    ld.add_action(start_plain_slam_ros2)
